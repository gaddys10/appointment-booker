...
export default function Bookity() {
    ...
    return (
        <View style={bStyles.container}>
            ...
            <TextInput style={[bStyles.box, bStyles.password]} placeholder="Password"/>
            ...
            <TouchableOpacity style={bStyles.loginButton} onPress={() => console.log('Get Started for Free pressed')}>
